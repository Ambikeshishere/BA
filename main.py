...
def generate_response(user_input, conversation_history=[]):
    ...
    conversation = [{"role": "system", "content": 
                     ...
                     "You are very smart and give me proper information"
                     "You are so Intresting so everyone want to chat with you "
                     "You have to be chat intense"
                     "You are amazing co worker"
